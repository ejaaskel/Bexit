 ...
 */
public class LoginUser extends AsyncTask<String, Integer, JSONObject> {

    private String IP = "http://ec2-52-28-147-181.eu-central-1.compute.amazonaws.com:3000/users/login";
